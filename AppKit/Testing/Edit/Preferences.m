...
- (void) dealloc							{}
- (NSDictionary *) preferences				{ return curValues; }
...
{
    [field setStringValue:font ? [NSString stringWithFormat:@"%@ %g", 
...
- (void)ok:(id)sender					{ [self commitDisplayedValues]; }
...
- (void)revert:(id)sender				{ [self discardDisplayedValues]; }
