...
main(int argc, char** argv, char** envp)
{
	...
	printf("create a dictionary via dictionaryWithObjectsAndKeys:\n");
	dic = [NSDictionary dictionaryWithObjectsAndKeys:
			...
			[NSNumber numberWithInt:30], @"WindowHeight", nil];
	...
	dic = [[NSDictionary alloc] initWithObjects:o forKeys:k count:1];
	printf("Dict w/objs,keys %s\n", [[dic description] cString]);
	}
	
	[arp release];

	printf("nsdictionary test complete\n");
