...
original_test ()
{
  ...
  b = [s1 allObjects];
  assert ([b containsObject:[a objectAtIndex: 0]]);
  assert ([b containsObject:[a objectAtIndex: 1]]);
  assert ([b containsObject:[a objectAtIndex: 2]]);
  assert ([b containsObject:[a objectAtIndex: 3]]);
}
